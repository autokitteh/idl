...
var (
	filter_LitterBox_Setup_1 = &utilities.DoubleArray{Encoding: map[string]int{"files_txtar": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func RegisterLitterBoxHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LitterBoxServer) error {
	...
	mux.Handle("GET", pattern_LitterBox_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_LitterBox_Get_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
