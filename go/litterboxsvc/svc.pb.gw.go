...
var (
	filter_LitterBox_Setup_0 = &utilities.DoubleArray{Encoding: map[string]int{"files_txtar": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_LitterBox_Setup_0(ctx context.Context, marshaler runtime.Marshaler, client LitterBoxClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.FilesTxtar); err != nil && err != io.EOF {
...
func request_LitterBox_Setup_2(ctx context.Context, marshaler runtime.Marshaler, client LitterBoxClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetupRequest
	var metadata runtime.ServerMetadata
...
func local_request_LitterBox_Setup_2(ctx context.Context, marshaler runtime.Marshaler, server LitterBoxServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SetupRequest
	var metadata runtime.ServerMetadata
...
func request_LitterBox_Get_0(ctx context.Context, marshaler runtime.Marshaler, client LitterBoxClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_LitterBox_Get_0(ctx context.Context, marshaler runtime.Marshaler, server LitterBoxServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRequest
	var metadata runtime.ServerMetadata
...
func request_LitterBox_Get_1(ctx context.Context, marshaler runtime.Marshaler, client LitterBoxClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRequest
	var metadata runtime.ServerMetadata
...
func local_request_LitterBox_Get_1(ctx context.Context, marshaler runtime.Marshaler, server LitterBoxServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetRequest
	var metadata runtime.ServerMetadata
...
func RegisterLitterBoxHandlerServer(ctx context.Context, mux *runtime.ServeMux, server LitterBoxServer) error {
	...
	mux.Handle("POST", pattern_LitterBox_Setup_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Setup", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}/files"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_LitterBox_Setup_2(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_LitterBox_Setup_2(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_LitterBox_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Get", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_LitterBox_Get_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_LitterBox_Get_0(ctx, mux, outboundMarshaler, w, req, response_LitterBox_Get_0{resp}, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_LitterBox_Get_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Get", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}/files"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_LitterBox_Get_1(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_LitterBox_Get_1(ctx, mux, outboundMarshaler, w, req, response_LitterBox_Get_1{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterLitterBoxHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LitterBoxClient) error {
	...
	mux.Handle("POST", pattern_LitterBox_Setup_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Setup", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}/files"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_LitterBox_Setup_2(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_LitterBox_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Get", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_LitterBox_Get_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_LitterBox_Get_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Get", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}/files"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_LitterBox_Get_1(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_LitterBox_Run_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/autokitteh.litterbox.LitterBox/Run", runtime.WithHTTPPathPattern("/api/v1/litterboxes/{id}/run"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_LitterBox_Get_0 struct {
	proto.Message
}

func (m response_LitterBox_Get_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetResponse)
	return response.FilesTxtar
}

type response_LitterBox_Get_1 struct {
	proto.Message
}

func (m response_LitterBox_Get_1) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetResponse)
	return response.FilesTxtar
}
...
var (
	...
	pattern_LitterBox_Setup_2 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "litterboxes", "id", "files"}, ""))

	pattern_LitterBox_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "litterboxes", "id"}, ""))

	pattern_LitterBox_Get_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "litterboxes", "id", "files"}, ""))
	...
	pattern_LitterBox_Run_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "litterboxes", "id", "run"}, ""))
...
var (
	...
	forward_LitterBox_Setup_2 = runtime.ForwardResponseMessage

	forward_LitterBox_Get_0 = runtime.ForwardResponseMessage

	forward_LitterBox_Get_1 = runtime.ForwardResponseMessage
